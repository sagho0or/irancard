...
var largeImageOptions = {
    largeImageContainerId: "imageSliderLargeImage",
    AutoDisplay: true,
...
function slider(t) {
    ...
    n.prototype = {
        ...
        l: function(d) {
            if (this.f) {
                for (var b = g(d.parentNode), c = "", a = 0; a < b.length; a++)
                    if (b[a].className == "description") {
                        c = b[a].innerHTML;
                        break
                    }
                this.f.innerHTML = c;
                if (largeImageOptions.DescriptionAnimation) {
                    ...
                    this.f.style.top = this.a.offsetHeight + "px";
                    this.m(this.f.offsetHeight)
    ...
    m.prototype = {
                ...
                case 1:
                    ...
                    if (!k || a[2]) {
                        if (a[4]) {
                            ...
                            i = h[c];
                            for (var j = 1; j < f; j++)
                                if (d == 0 && h[j].offsetLeft > e.offsetWidth || d == 1 && h[j].offsetTop > e.offsetHeight) {
                                    c = j - 1;
                                    if (c == 0) c++;
                                    i = h[c];
        ...
        l: function(d) {
            k = 1;
            if (!a[4]) {
                for (var c = this.d.getElementsByTagName("div"), b = 0; b < c.length; b++)
                    if (b == d) c[b].className = "focus";
    ...
    var q = function() {
        if (document.getElementById(a[3])) {
            j = new n;
            l = new m(document.getElementById(a[3]))
        }
    }, u = function(a) {
            p(a);
            r(function() {
